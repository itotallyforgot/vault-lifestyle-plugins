...
| Term | Meaning |
|---|---|
| vault | A `markdown-vault`-shaped Obsidian knowledge vault. It owns `raw/`, `wiki/`, vault skills, and vault-side processing rules. |
| standalone vault | The rule that `markdown-vault` must work without this repo or any other plug-in installed. |
...
- `markdown-vault` is sovereign. This repo does not require changes to
  `markdown-vault` skills, maps, or harness config.
